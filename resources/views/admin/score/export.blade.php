    ...
    @foreach($cabang as $c)
        ...
        <table style="border-collapse: collapse">
            ...
            <?php
                ...
                $score_jual = DB::table('history_jual')->select('kd_sales', 'tgl', 'divisi', DB::raw('SUM(skor) AS total_skor'))->whereBetween('tgl', [$tgl_a, $tgl_b])->groupBy('kd_sales')->Where('divisi', 'like', '%'.$c->inisial.'%')->orderBy('total_skor', 'desc')->get();
            ?>
