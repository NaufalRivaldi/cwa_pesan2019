            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a class="nav-item nav-link" href="{{ url('/backend/member') }}"><i class="fas fa-user-plus"></i></i> Admin</span></a>
                        <a class="nav-item nav-link" href="{{ url('/backend/member') }}"><i class="fas fa-user"></i> Member</span></a>
                    </div>
                </div>
            </div>
        </nav>
