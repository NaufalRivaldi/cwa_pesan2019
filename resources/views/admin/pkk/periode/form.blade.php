  ...
  <div class="row justify-content-md-center">
    <div class="col-md-12">
      ...
      <div class="card-header">
          <a href="{{ route('pkk.periode') }}" class="btn btn-success btn-sm"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
      </div>
        <div class="card-body">   
              <form action="{{ ($id)? route('pkk.periode.update') : route('pkk.periode.add') }}" method="post">
                ...
                <div class="form-group row">
                    ...
                    <option value="">Pilih...</option>
                        ...
                        <option {{($id)? ($periode->kategori == '2') ? 'selected': '' : ''}} value="2">Penilaian Kepala Departemen</option>
                        <option {{($id)? ($periode->kategori == '3') ? 'selected': '' : ''}} value="3">Penilaian Kepala Toko</option>
                        <option {{($id)? ($periode->kategori == '4') ? 'selected': '' : ''}} value="4">Survei Kepuasan Karyawan</option>
                    </select>
