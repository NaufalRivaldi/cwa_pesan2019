                               ...
                               @foreach($data['user'] as $row)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($row->stat == 1)
                                                <a href="{{ url('backend/user/nonactive'.$row->id) }}" class="btn btn-sm btn-warning">Nonactive</a>
                                            @else
                                                <a href="{{ url('backend/user/active'.$row->id) }}" class="btn btn-success btn-sm">Active</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
